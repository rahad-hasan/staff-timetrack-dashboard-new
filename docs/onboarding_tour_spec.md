...
| 4 | `orientation` tour — ⌘K → metrics → sidebar → timer → appearance → profile → **download (`/download`, the finale)** | "Show me around" |
