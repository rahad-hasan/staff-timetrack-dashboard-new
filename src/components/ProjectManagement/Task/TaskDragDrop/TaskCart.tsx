...
const TaskCart = ({ task }: { task: ITask }) => {
    ...
    return (
        <div className=" border p-6 rounded-lg bg-white dark:bg-darkSecondaryBg cursor-grab" >
            <h2 className=' text-lg font-semibold dark:text-darkTextPrimary'>{task?.taskName}</h2>
            <div className=' mt-3 flex items-center justify-between'>
                ...
                <div className=' border-2 border-borderColor dark:border-darkBorder rounded-lg flex items-center gap-4 justify-between px-2 py-2'>
                    <h2 className=' flex items-center gap-1 dark:text-darkTextPrimary'>
            ...
            <div className=' mt-3 '>
                <div className=' flex justify-between items-center mb-2 dark:text-darkTextPrimary'>
                    <p>Checklist</p>
                    <p>{task?.checklist}/10</p>
                </div>
                <Slider disabled className={sliderClass} defaultValue={[33]} max={100} step={1} />
                <div className=' mt-3 flex items-center justify-between'>
                    <div className=' flex items-center gap-1 dark:text-darkTextPrimary'>
                        <Clock9 size={18} />
                        <p>06:17:09</p>
                    </div>
                    <div className=' flex items-center gap-1 dark:text-darkTextPrimary'>
