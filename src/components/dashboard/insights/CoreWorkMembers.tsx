    ...
    return (
        <div>
            <div className=" flex items-center justify-between mt-5">
                ...
                <Button className=" text-sm md:text-base" variant={'outline2'} size={'sm'}><span className=" hidden sm:block">Top Core worker</span><span className=" sm:hidden">Top worker</span> <ChevronDown size={20} /></Button>
            </div>
            <div className=" mt-5">
                <Table>
                    <TableHeader>
