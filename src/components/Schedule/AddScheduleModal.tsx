...
const AddScheduleModal = ({ onClose }: { onClose: () => void }) => {
    ...
    return (
        <DialogContent className="sm:max-w-[525px]">
            <DialogHeader>
                <DialogTitle className=" mb-2">Create Schedule</DialogTitle>
            </DialogHeader>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input type="text" className="dark:bg-darkPrimaryBg dark:border-darkBorder -mb-2" placeholder="Schedule name" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
