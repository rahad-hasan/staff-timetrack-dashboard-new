...
const SingleMemberPage = ({ data }: { data: any }) => {
    ...
    // popularTimeZones array can be imported or kept local as per your Configuration component
    ...
    const form = useForm<z.infer<typeof memberSchema>>({
        ...
        defaultValues: {
            ...
            time_zone: data?.time_zone || "Asia/Dhaka",
        },
    });
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center text-sm text-headingTextColor dark:text-darkTextPrimary">
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs text-textGray opacity-70">Allow member to log in and access the system</span>
                        </div>
                        <Switch
                    ...
                    <div className="flex justify-between items-center text-sm text-headingTextColor dark:text-darkTextPrimary">
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs text-textGray opacity-70">Enable desktop app activity recording</span>
                        </div>
                        <Switch
                    ...
                    <div className="flex justify-between items-center text-sm text-headingTextColor dark:text-darkTextPrimary">
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs text-textGray opacity-70">Record specific website and application usage</span>
                        </div>
                        <Switch
                    ...
                    <div className="flex justify-between items-center text-sm text-headingTextColor dark:text-darkTextPrimary">
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs text-textGray opacity-70">Require an extra security step during login</span>
                        </div>
                        <Switch
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex flex-col">
                                        <FormLabel className="mb-1">Time Zone</FormLabel>
                                        <Popover>
                                                        ...
                                                        <CommandGroup>
                                                            {popularTimeZones.map((tz) => (
                                                                <CommandItem
                                                                    key={tz.value}
                                                                    value={tz.label}
                                                                    onSelect={() => form.setValue("time_zone", tz.value)}
                                                                >
                                                                    <Check className={cn("mr-2 h-4 w-4", tz.value === field.value ? "opacity-100" : "opacity-0")} />
                                                                    {tz.label}
                                                                </CommandItem>
                                                            ))}
                                                        </CommandGroup>
