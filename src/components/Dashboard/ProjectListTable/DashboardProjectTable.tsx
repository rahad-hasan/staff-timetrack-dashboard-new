  ...
  const columns: ColumnDef<IProject>[] = [
        ...
        return (
          <div className="flex items-center">
            {visibleAssignee.map((item, index) => (
              <Avatar key={index} className={index !== 0 ? "-ml-3" : ""}>
                <AvatarImage src={item?.image ?? ""} alt={item?.name ?? "assignee"} />
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="">
            {format(new Date(deadline), "EEE, MMM d, yyyy")}
          </div>
        );
      },
    },
            ...
            logInUserData?.role === "hr" ? (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    <span
                      className={` w-2 h-2 rounded-full ${status === "processing" ? "bg-[#efaf07] " : status === "cancelled" ? "bg-[#f40139]" : status === "pending" ? "bg-[#5db0f1]" : "bg-[#26bd6c]"}`}
                    ></span>
                    {status}
                    <ChevronDown />
                  </Button>
                ...
                <DropdownMenuContent
                  align="end"
                  className=" space-y-2 w-[200px] p-2 rounded-lg"
                >
                  <DropdownMenuItem
                  ...
                  >
                    {status === "processing" && (
                      <Check className=" bg-[#efaf07] text-white rounded-full p-0.5" />
                    )}
                    In Progress
                  </DropdownMenuItem>
                  ...
                  >
                    {status === "cancelled" && (
                      <Check className=" bg-[#f40139] text-white rounded-full p-0.5" />
                    )}
                    Cancel
                  </DropdownMenuItem>
                  ...
                  >
                    {status === "pending" && (
                      <Check className=" bg-[#5db0f1] text-white rounded-full p-0.5" />
                    )}
                    Pending
                  </DropdownMenuItem>
                  ...
                  >
                    {status === "complete" && (
                      <Check className=" bg-[#26bd6c] text-white rounded-full p-0.5" />
                    )}
                    Done
                  </DropdownMenuItem>
                </DropdownMenuContent>
  ...
  return (
    <div className="mt-5 border border-borderColor/60 dark:border-darkBorder/50 dark:bg-darkPrimaryBg p-4 2xl:p-5 rounded-[12px]">
      <div className=" flex justify-between items-center mb-5">
        <h2 className=" text-base sm:text-lg text-headingTextColor dark:text-darkTextPrimary uppercase">
          Project list
        </h2>
