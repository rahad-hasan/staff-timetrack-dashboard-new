    ...
    return (
        <div className=" border-2 border-borderColor dark:border-darkBorder py-3 px-5 rounded-[12px] w-full">
            ...
            <div className=" flex items-center justify-between mt-8 pb-5 border-b dark:border-darkBorder">
                <div className="">
                    <div className=" mb-2">
                        <h2 className=" text-xl font-semibold dark:text-darkTextPrimary">2:22</h2>
                        <p className="dark:text-darkTextPrimary">Focus time</p>
                    </div>
                    <div className=" mb-2">
                        <h2 className=" text-xl font-semibold dark:text-darkTextPrimary">2:22</h2>
                        <p className=" dark:text-darkTextPrimary">Focus sessions</p>
                    </div>
                    <div className=" mb-2">
                        <h2 className=" text-xl font-semibold dark:text-darkTextPrimary">2:22</h2>
                        <p className="dark:text-darkTextPrimary">Avg. session length</p>
                    </div>
                </div>
                <div className="">
