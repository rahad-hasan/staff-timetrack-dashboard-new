...
const SideBar = () => {
    ...
    return (
        <div className='overflow-y-scroll no-scrollbar sticky top-0 scroll-smooth'>
            <div className={`${isCollapsed ? "w-[90px]" : "w-[320px]"} h-screen py-5 z-50  flex flex-col transition-all duration-300`}>
                <div
