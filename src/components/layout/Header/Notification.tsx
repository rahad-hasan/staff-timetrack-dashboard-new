    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <div className="relative w-[25px] h-[25px] cursor-pointer">
          ...
          />
          {unreadCount > 0 && (
            <span className="absolute -top-1 -right-1.5 min-w-4 px-0.5 h-4 text-[9px] font-bold text-white bg-red-600 rounded-full flex items-center justify-center border border-white dark:border-red-600">
              {unreadCount}
            </span>
          )}
        </div>
