...
const DarkMoodToggle = () => {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger className="  dark:border-darkBorder dark:hover:bg-darkSecondaryBg" asChild>
                <Button data-tour={TOUR_ANCHORS.themeToggle} variant="outline" size="icon">
