    ...
    return (
        <div className=" border-b-2 border-borderColor py-5 px-5 flex items-center justify-between">
            ...
            <div className=" flex items-center gap-4">
                ...
                <Button variant={'outline2'} className=" py-[5px]"><Image src={`https://avatar.iran.liara.run/public/18`} width={200} height={200} className="w-8" alt="download" />Dannielis Vettori <ChevronDown size={20} /></Button>
            </div>
        </div>
    );
};
