...
import settingImage from "@/assets/settings/current_plan.png";
...
export default function SeatUsageCard({
  ...
  return (
    <div className=" w-full flex justify-between gap-5 md:gap-16 mt-5 lg:mt-0 lg:pl-8 lg:border-l lg:border-borderColor lg:dark:border-darkBorder">
      ...
      <Image src={settingImage} className=" w-[250px] lg:w-[160px]" width={200} height={200} alt="Setting" />
    </div>
  );
}
