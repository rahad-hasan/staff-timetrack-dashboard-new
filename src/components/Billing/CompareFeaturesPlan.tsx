...
const RenderCell = ({ value }: { value: boolean | string | null | undefined }) => {
  if (value === true) {
...
const tableData: TableRow[] = [
  ...
  { feature: "Screenshot Monitoring", starter: "1 screenshot/hour", pro: "20 screenshots/hour", enterprise: true },
  { feature: "Apps Usage Tracking", starter: "Up to 5 apps / user / day", pro: true, enterprise: true },
  ...
  { feature: "Payroll and Members", starter: false, pro: true, enterprise: true },
  { feature: "All from Pro", starter: false, pro: false, enterprise: true },
  { feature: "More screenshots", starter: false, pro: false, enterprise: "60 screenshots/hour" },
  ...
  { feature: "Max seats", starter: "10", pro: "Unlimited", enterprise: "Unlimited" },
  { feature: "Max projects", starter: "3", pro: "Unlimited", enterprise: "Unlimited" },
  { feature: "Timesheet retention days", starter: "30", pro: "Unlimited", enterprise: "Unlimited" },
  { feature: "Apps tracking daily limit", starter: "5", pro: "Unlimited", enterprise: "Unlimited" },
  { feature: "Urls tracking daily limit", starter: "5", pro: "Unlimited", enterprise: "Unlimited" },
  { feature: "Screenshot interval in minute", starter: "Every 60 min", pro: "Every 3 min", enterprise: "Every 1 min" },
  { feature: "Attendance leaves retention days", starter: "30", pro: "Unlimited", enterprise: "Unlimited" },
  { feature: "Activity analytics retention days", starter: "14", pro: "Unlimited", enterprise: "Unlimited" },
];
              ...
              if (row.isCategory) {
                return (
                  <tr key={index} className="bg-gray-50 dark:bg-gray-800">
                    <td colSpan={4} className="p-4 font-bold text-xs uppercase tracking-wider text-headingTextColor dark:text-darkTextPrimary border-t border-b border-borderColor/60">
                      {row.feature}
                    </td>
                  </tr>
                );
