...
const MonthlyTimeSheetsCalendar = ({ data }: any) => {
    ...
    const DateCell = ({
        ...
        >
            ...
            {!isPadding && (
                <>
                    <span className="font-medium text-lg mb-1 text-headingTextColor/70 dark:text-darkTextSecondary/90">{dayNumber}</span>
                    {
                        viewType === "Hours" ?
                            <div>
                                {formattedTime && (
                            ...
                            <div>
                                ...
                                <div className="px-5 py-1 text-sm font-medium bg-gray-50 rounded-lg dark:bg-gray-900/25 text-primary">
                                    {`${activity || 0}%`}
                                </div>
                            </div>
                    }
