      ...
      cell: ({ row }) => {
        return (
          <div className="flex items-center gap-2 text-primary">
            <span>
              {row?.original?.is_manual ? <CheckIcon size={22} /> : ""}
            </span>
          </div>
        );
      },
          ...
          <div className=" flex items-center justify-between">
            <div className=" flex justify-between gap-4">
              <div className="">
                ...
                <p className=" text-sm font-thin text-subTextColor dark:text-darkTextSecondary">
                  {row?.original?.span?.start_local} -{" "}
                  {row?.original?.span?.end_local}
                </p>
              </div>
            </div>
            <FilterButton />
