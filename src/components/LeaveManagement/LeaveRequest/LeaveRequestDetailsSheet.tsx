      ...
      >
        ...
        <div className="space-y-5 px-6 py-5">
          {leave ? (
            <>
              <div
                className="rounded-[28px] border bg-white p-5 shadow-sm dark:bg-darkPrimaryBg"
                style={{
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="min-w-0">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="truncate text-sm text-subTextColor">
                  ...
                  {leave.user ? (
                    <Button asChild variant="outline2" className="dark:bg-darkSecondaryBg">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="rounded-[22px] border border-borderColor bg-white px-4 py-4 dark:border-darkBorder dark:bg-darkPrimaryBg">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="flex items-center justify-between rounded-[22px] border border-borderColor bg-white px-4 py-4 dark:border-darkBorder dark:bg-darkPrimaryBg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-subTextColor">Requested date span</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-[22px] border border-borderColor bg-white px-4 py-4 dark:border-darkBorder dark:bg-darkPrimaryBg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-subTextColor">Calculated time coverage</p>
                    </div>
                  </div>
                  <span className="text-sm font-medium text-headingTextColor dark:text-darkTextPrimary">
                ...
                <div className="flex items-center justify-between rounded-[22px] border border-borderColor bg-white px-4 py-4 dark:border-darkBorder dark:bg-darkPrimaryBg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-subTextColor">Internal reviewer checkpoint</p>
                    </div>
                  </div>
                  <span className="text-sm font-medium text-headingTextColor dark:text-darkTextPrimary">
                ...
                <div className="flex items-center justify-between rounded-[22px] border border-borderColor bg-white px-4 py-4 dark:border-darkBorder dark:bg-darkPrimaryBg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-subTextColor">Final reviewer checkpoint</p>
                    </div>
                  </div>
                  <span className="text-sm font-medium text-headingTextColor dark:text-darkTextPrimary">
              ...
              <div className="rounded-[24px] border border-borderColor bg-white p-5 shadow-sm dark:border-darkBorder dark:bg-darkPrimaryBg">
                ...
                <p className="mt-3 whitespace-pre-wrap break-words text-sm leading-6 text-subTextColor">
                  {leave.reason}
                </p>
              </div>
              ...
              <div className="rounded-[24px] border border-borderColor bg-white p-5 shadow-sm dark:border-darkBorder dark:bg-darkPrimaryBg">
                ...
                {attachment ? (
                  <div className="mt-4 space-y-4">
                    <div className="rounded-2xl bg-bgSecondary/60 px-4 py-3 text-sm text-subTextColor dark:bg-darkSecondaryBg">
                    ...
                    {isPdfAttachment(attachment) ? (
                      <div className="overflow-hidden rounded-[22px] border border-borderColor dark:border-darkBorder">
                        <iframe
                          src={attachment.url}
                      ...
                      <div className="overflow-hidden rounded-[22px] border border-borderColor bg-bgSecondary/40 dark:border-darkBorder dark:bg-darkSecondaryBg">
                      ...
                      <div className="rounded-[22px] border border-dashed border-borderColor px-4 py-10 text-center text-sm text-subTextColor dark:border-darkBorder">
                        This file type cannot be previewed inline. Use <code>Open file</code> to review it.
                      </div>
                    )}
                  </div>
                ) : (
                  <div className="mt-4 rounded-[22px] border border-dashed border-borderColor px-4 py-10 text-center text-sm text-subTextColor dark:border-darkBorder">
              ...
              {canTakeAction ? (
                <div className="rounded-[24px] border border-borderColor bg-white p-5 shadow-sm dark:border-darkBorder dark:bg-darkPrimaryBg">
                  ...
                  {canReviewAction ? (
                    ...
                    <div className="mt-4 rounded-[22px] border border-dashed border-borderColor px-4 py-8 text-center text-sm text-subTextColor dark:border-darkBorder">
            ...
            <div className="rounded-[24px] border border-dashed border-borderColor px-5 py-10 text-center text-subTextColor dark:border-darkBorder">
