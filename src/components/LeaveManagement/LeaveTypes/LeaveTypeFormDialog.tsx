  ...
  return (
    ...
    >
      <div className="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          type="color"
                          className="h-10 w-full cursor-pointer rounded-xl border border-borderColor bg-white px-2 dark:border-darkBorder dark:bg-darkPrimaryBg"
        ...
        <div className="bg-bgSecondary/50 p-4 dark:bg-darkPrimaryBg sm:p-6">
          <div
            className="rounded-[24px] border bg-white p-5 shadow-sm dark:bg-darkSecondaryBg sm:rounded-[28px]"
            style={{
          ...
          >
            ...
            <div className="mt-5 space-y-3">
              <div className="flex flex-col gap-2 rounded-2xl bg-bgSecondary px-4 py-3 text-sm dark:bg-darkPrimaryBg sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-2">
                  <ShieldCheck className="size-4 text-primary" />
                  <span className="text-subTextColor">Applicable to</span>
                </div>
              ...
              <div className="flex flex-col gap-2 rounded-2xl bg-bgSecondary px-4 py-3 text-sm dark:bg-darkPrimaryBg sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-subTextColor">Min notice</span>
                </div>
                <span className="font-medium text-headingTextColor dark:text-darkTextPrimary">
              ...
              <div className="flex flex-col gap-2 rounded-2xl bg-bgSecondary px-4 py-3 text-sm dark:bg-darkPrimaryBg sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-subTextColor">Attachment</span>
                </div>
                <span className="font-medium text-headingTextColor dark:text-darkTextPrimary">
