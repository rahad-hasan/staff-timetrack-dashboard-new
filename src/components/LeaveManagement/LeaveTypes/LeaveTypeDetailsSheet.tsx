                ...
                <div className="flex items-center justify-between rounded-[22px] border border-borderColor bg-white px-4 py-4 dark:border-darkBorder dark:bg-darkPrimaryBg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-subTextColor">Eligibility rule</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between rounded-[22px] border border-borderColor bg-white px-4 py-4 dark:border-darkBorder dark:bg-darkPrimaryBg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-subTextColor">Advance planning requirement</p>
                    </div>
                  </div>
                  <span className="text-sm font-medium text-headingTextColor dark:text-darkTextPrimary">
                ...
                <div className="flex items-center justify-between rounded-[22px] border border-borderColor bg-white px-4 py-4 dark:border-darkBorder dark:bg-darkPrimaryBg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-subTextColor">Document submission requirement</p>
                    </div>
                  </div>
                  <span className="text-sm font-medium text-headingTextColor dark:text-darkTextPrimary">
