  ...
  return (
    ...
    >
      <div className="grid max-h-[95vh] grid-rows-[auto_minmax(0,1fr)_auto]">
        <div className="relative overflow-hidden border-b border-borderColor dark:border-darkBorder">
          ...
          <div className="relative px-5 py-5 sm:px-8 sm:py-7">
            <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_320px] xl:items-start">
              <div>
                <Badge className="border border-primary/20 bg-white/90 px-3 py-1 text-primary shadow-sm backdrop-blur dark:border-primary/20 dark:bg-darkPrimaryBg/75 dark:text-emerald-300">
                  Holiday parser
                </Badge>
                ...
                <div className="mt-5 flex flex-wrap gap-3 text-sm">
                  <Badge className="border border-white/70 bg-white/90 px-3 py-1.5 text-headingTextColor shadow-sm dark:border-white/8 dark:bg-darkPrimaryBg/70 dark:text-darkTextPrimary">
                  ...
                  <Badge className="border border-white/70 bg-white/90 px-3 py-1.5 text-subTextColor shadow-sm dark:border-white/8 dark:bg-darkPrimaryBg/70 dark:text-darkTextSecondary">
                    File types: CSV, TSV, TXT, PSV, PDF
                  </Badge>
                </div>
              </div>

              <div className="rounded-[28px] border border-white/70 bg-white/90 p-5 shadow-sm backdrop-blur dark:border-white/8 dark:bg-darkPrimaryBg/70">
        ...
        <div className="overflow-y-auto overflow-x-hidden px-5 py-5 sm:px-8 sm:py-6">
          <div className="space-y-6">
            <div className="grid gap-6 xl:grid-cols-[minmax(0,1.45fr)_320px]">
              <div className="rounded-[28px] border border-borderColor bg-white/95 p-5 shadow-sm dark:border-darkBorder dark:bg-darkPrimaryBg">
                <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                  ...
                  <div className="rounded-[20px] border border-borderColor bg-bgSecondary/60 px-4 py-3 text-sm dark:border-darkBorder dark:bg-darkSecondaryBg">
                ...
                <div className="mt-6 grid gap-4 lg:grid-cols-[minmax(0,1fr)_260px]">
                  <div className="rounded-[24px] border border-dashed border-borderColor bg-[linear-gradient(135deg,#ffffff_0%,#f9fcff_100%)] p-4 sm:p-5 dark:border-darkBorder dark:bg-[linear-gradient(135deg,rgba(40,46,59,1)_0%,rgba(27,32,43,1)_100%)]">
                  ...
                  <div className="rounded-[24px] border border-borderColor bg-bgSecondary/60 p-4 dark:border-darkBorder dark:bg-darkSecondaryBg">
                    <p className="text-sm font-semibold text-headingTextColor dark:text-darkTextPrimary">
                      Parser notes
                    </p>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-[28px] border border-borderColor bg-white p-5 shadow-sm dark:border-darkBorder dark:bg-darkPrimaryBg">
                  ...
                  <div className="mt-4 space-y-3">
                    <div className="rounded-[18px] bg-bgSecondary/60 px-4 py-3 dark:bg-darkSecondaryBg">
            ...
            {parseResult ? (
                ...
                <div className="grid gap-6 2xl:grid-cols-[minmax(0,1.08fr)_minmax(0,0.92fr)]">
                  <div className="rounded-[28px] border border-borderColor bg-white p-5 shadow-sm dark:border-darkBorder dark:bg-darkPrimaryBg">
                    ...
                    {parsedRows.length ? (
                        ...
                        <div className="grid gap-4 lg:hidden">
                          {parsedRows.map((row) => (
                            <div
                              ...
                              className="rounded-[20px] border border-borderColor bg-bgSecondary/40 p-4 dark:border-darkBorder dark:bg-darkSecondaryBg"
                            >
                      ...
                      <div className="rounded-[20px] border border-dashed border-borderColor px-4 py-12 text-center text-subTextColor dark:border-darkBorder dark:text-darkTextSecondary">
                      ...
                      <>
                        <div className="grid gap-4 lg:hidden">
                          {rejectedRows.map((row, index) => (
                            <div
                              key={`${row.row}-${index}`}
                              className="rounded-[20px] border border-red-200 bg-red-50/60 p-4 dark:border-red-900/50 dark:bg-red-950/20"
                            >
                              <div className="flex items-start justify-between gap-3">
                                <div>
                                  <p className="text-base font-semibold text-headingTextColor dark:text-darkTextPrimary">
              ...
              <div className="rounded-[28px] border border-dashed border-borderColor bg-white/70 px-6 py-12 text-center shadow-sm dark:border-darkBorder dark:bg-darkPrimaryBg">
                <p className="text-lg font-semibold text-headingTextColor dark:text-darkTextPrimary">
