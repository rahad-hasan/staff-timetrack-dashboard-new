...
const LeaveDataDetailsModal = ({ data }: { data: IUserLeaveData }) => {
    ...
    const LeaveCard = ({
        ...
        return (
            <div className="group relative overflow-hidden rounded-2xl border border-gray-100 dark:border-white/5 bg-white dark:bg-darkPrimaryBg p-4 shadow-sm transition-all hover:shadow-md">
                ...
                <div className="relative mt-3 h-1.5 w-full rounded-full bg-gray-100 dark:bg-darkSecondaryBg">
                    <div
                ...
                <div className="mt-3 flex justify-between items-center text-[11px] font-medium">
                    <span className="text-gray-400 uppercase ">Used: {stats?.taken}</span>
                    <span className="text-gray-400 uppercase">Quota: {stats?.allowed}</span>
                </div>
            </div>
        );
    };
    ...
    return (
        <DialogContent
            ...
            className="border-none bg-gray-50 dark:bg-darkSecondaryBg p-0 sm:max-w-[550px] overflow-hidden shadow-2xl"
        >
            <div className="bg-white dark:bg-darkPrimaryBg px-6 pt-8 pb-6 border-b dark:border-white/5">
                ...
                <div className="mt-8 grid grid-cols-3 gap-4 rounded-2xl bg-gray-50 dark:bg-darkSecondaryBg p-5">
                    ...
                    <div className="space-y-1 border-x border-gray-200 dark:border-white/10 px-4">
                        ...
                        <p className="text-3xl font-black text-gray-500 dark:text-darkTextSecondary">{data?.total_taken}</p>
                    </div>
            ...
            <div className="px-6 pb-6">
                <div className="mb-4 flex items-center justify-between">
                    <h3 className="text-xs font-bold uppercase tracking-widest text-gray-400">Leave Breakdown</h3>
