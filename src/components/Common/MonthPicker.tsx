    ...
    return (
        <div className="flex w-full">
            <ChevronLeft
                ...
                className="border p-2.5  w-12 sm:w-10 h-10 border-borderColor dark:border-darkBorder text-headingTextColor dark:text-darkTextPrimary rounded-lg cursor-pointer"
            />
