...
const WeeklyDatePicker = ({ centerDate, setCenterDate }: WeeklyDatePickerProps) => {
    ...
    return (
        <div className="flex">
            <ChevronLeft onClick={() => handleNavigate(-1)} className="border p-2.5 w-10 h-10 border-borderColor dark:border-darkBorder text-headingTextColor dark:text-darkTextPrimary rounded-lg cursor-pointer" />
            ...
            <ChevronRight onClick={() => handleNavigate(1)} className="border p-2.5 w-10 h-10 border-borderColor dark:border-darkBorder text-headingTextColor dark:text-darkTextPrimary rounded-lg cursor-pointer" />
        </div>
    );
};
