      ...
      {filteredHolidays.length ? (
        ...
        <div className="flex justify-center h-68">
          <EmptyTableRow
            ...
            text={
              noMatches
                ? `No holiday matched "${searchDraft.trim()}". Try a different holiday name, source label, or description keyword.`
                : canManageHolidays
                  ? `No holidays loaded for ${selectedYear}. Add the first holiday manually or import a structured file for this year.`
                  : `No holidays loaded for ${selectedYear}. An admin or HR user can create or import holidays for this year.`
            }
          />
        </div>
      )}
