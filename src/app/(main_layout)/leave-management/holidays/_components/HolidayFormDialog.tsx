  ...
  return (
    ...
    >
      <div className="grid gap-0 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="border-b border-borderColor p-4 dark:border-darkBorder sm:p-5 lg:border-r lg:border-b-0">
          <DialogHeader>
        ...
        <div className="bg-[linear-gradient(180deg,rgba(248,250,252,0.95)_0%,rgba(255,255,255,1)_100%)] p-4 dark:bg-[linear-gradient(180deg,rgba(33,39,51,1)_0%,rgba(50,57,71,1)_100%)] sm:p-5">
          <div className="rounded-[12px] border border-borderColor p-5 dark:border-darkBorder dark:bg-darkPrimaryBg mt-5">
            <div className="flex items-start gap-2">
              <div className="rounded-3xl bg-primary/10 p-2 text-primary dark:bg-primary/15">
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm text-subTextColor dark:text-darkTextSecondary">{formattedDate}</p>
              </div>
            </div>

            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              <div className="rounded-[12px] border border-borderColor/70 bg-bgSecondary/70 p-4 dark:border-darkBorder dark:bg-darkSecondaryBg">
            ...
            <div className="mt-4 rounded-[12px] border border-borderColor/70 bg-bgSecondary/70 p-4 dark:border-darkBorder dark:bg-darkSecondaryBg">
              <div className="flex items-center gap-2 text-sm font-medium text-headingTextColor dark:text-darkTextPrimary">
          ...
          <div className="mt-4 rounded-[12px] border border-borderColor p-5 dark:border-darkBorder dark:bg-darkPrimaryBg">
