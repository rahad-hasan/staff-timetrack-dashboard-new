...
import MonthlyReportCharts from "@/components/Report/MonthlyReport/MonthlyReportCharts";
...
const MonthlyReportPage = async ({ searchParams }: ISearchParamsProps) => {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-borderColor/70 bg-white px-4 py-4 shadow-sm dark:border-darkBorder dark:bg-darkSecondaryBg sm:px-5">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="flex flex-col gap-3 xl:items-end">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="inline-flex h-11 items-center gap-2 rounded-2xl border border-borderColor bg-bgSecondary/70 px-4 text-sm font-medium text-headingTextColor dark:border-darkBorder dark:bg-darkPrimaryBg dark:text-darkTextPrimary">
      ...
      {report ? (
        <MonthlyReportCharts data={report} />
      ) : (
        <div className="rounded-2xl border border-dashed border-borderColor bg-white p-8 text-center text-sm text-subTextColor shadow-sm dark:border-darkBorder dark:bg-darkSecondaryBg dark:text-darkTextSecondary">
          {response?.message ||
