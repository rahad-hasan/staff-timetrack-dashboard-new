...
const loading = () => {
    ...
    return (
        <div className="border border-borderColor bg-bgSecondary dark:bg-darkPrimaryBg p-3 rounded-[12px] w-full lg:w-[50%] animate-pulse">
                    ...
                    {skeletonRows.map((_, index) => (
                        <div key={index} className="flex justify-between items-center py-2 border-b border-gray-100 last:border-b-0">
                            ...
                            <div className="flex flex-col items-start w-1/5 min-w-[120px]">
                                <div className="h-4 w-10 mb-1 bg-gray-200 rounded-full"></div>
                            ...
                            <div className="flex justify-end items-center gap-3 w-2/5">
                                <div className="flex flex-col items-end gap-1">
                                    ...
                                    <div className="flex flex-col items-end">
                                        <div className="h-4 w-26 bg-gray-200 mb-1 rounded"></div>
                                        <div className="h-3 w-32 bg-gray-100 rounded"></div>
                                    </div>
                                </div>
